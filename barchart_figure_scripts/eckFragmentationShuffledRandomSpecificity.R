...
# Read in data
for (ds in dss) {
  fn <- paste("eck_",ds,"/shf_rnd/1e-5/nrm_dmnd/eck_",ds,"_shf_rnd_1e-5_nrm_dmnd_kogs_per_cluster_summary.Rtab", sep="")
...
pdf("eckFragmentationShuffledRandomSpecificity.pdf", width=8.5, height=9)
eck.gg
dev.off()
