...
# Read in data
for (ds in dss) {
  fn <- paste("eck_",ds,"/ord_rnd/1e-5/nrm_dmnd/eck_",ds,"_ord_rnd_1e-5_nrm_dmnd_clusters_per_kog_summary.Rtab", sep="")
...
pdf("eckFragmentationOrderedRandomSensitivity.pdf", width=8.5, height=9)
eck.gg
dev.off()
