...
# Read in data
for (ds in dss) {
  fn <- paste("eck_11111111111/shf_rnd/1e-5/",ds,"_dmnd/eck_11111111111_shf_rnd_1e-5_",ds,"_dmnd_clusters_per_kog_summary.Rtab", sep="")
...
pdf("eckNormalizationSensitivity.pdf", width=8.5, height=9)
eck.gg
dev.off()
